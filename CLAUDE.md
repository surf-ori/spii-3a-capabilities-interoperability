...
Agent context for working on the `spii-3a-capabilities-interoperability` repository.

## What this repo is

The feedback and issue tracker for SPII deliverable 3A, Capabilities & Interoperability. It holds
